...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0d1d0a2c57585a7ecb9214caf1fca8d5) *)
(*
...
let setup_t =
  {
                      ...
                      (OASISExpr.EBool true,
                        ("ocamlbuild",
                          [
                             ...
                             "lib";
                             "\\\n-package";
                             "alcotest,js_of_ocaml,js_of_ocaml.ppx,commonjs_ppx";
                             "\\\ntest/test.byte";
                             "&&";
                             "\\\njs_of_ocaml";
                             "\"test/stubs.js\"";
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/angrylawyer/reactjs_of_ocaml";
          synopsis = "js_of_ocaml bindings for React.JS";
          description =
            Some
              [
                 OASISText.Para
                   "js_of_ocaml bindings for React.JS, including a syntax extension for easy creation of React elements."
              ];
          categories = [];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind",
                           ["install"; "reactjs_ppx"; "lib/ppx/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "reactjs_ppx"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("js_of_ocaml",
                               Some (OASISVersion.VGreaterEqual "2.6"));
                           FindlibPackage
                             ("js_of_ocaml.ppx",
                               Some (OASISVersion.VGreaterEqual "2.6"));
                           FindlibPackage ("commonjs_ppx", None)
                        ];
                   ...
                   {
                      lib_modules =
                        ["ReactJS"; "ReactDOM"; "ReactAddonsTestUtils"];
                      lib_pack = false;
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "npm"]
                   });
               SrcRepo
                 ({
                     cs_name = "master";
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/angrylawyer/reactjs_of_ocaml.git";
                      src_repo_browser =
                        Some
                          "https://github.com/angrylawyer/reactjs_of_ocaml";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "7+\248\232\211H\198V\254\2454\216\233\184\012N";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
