...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2ea2a745ef173be6d13b8194d3fc238d) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("test/run_tests", []))];
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("js_of_ocaml", ["\"_build/test/test.byte\""])))
                 ]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\019|Gª\138Ù“ˆ…»\024v0À∫[";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
