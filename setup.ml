...
(* OASIS_START *)
(* DO NOT EDIT (digest: c432832cf2ade6e2c738e8ef20115d33) *)
(*
...
let setup_t =
  {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("js_of_ocaml",
                           ["\"test/stubs.js\""; "\"_build/test/test.byte\""])))
                 ]
            };
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\205n\222\217:E\022\228\182\176=\160o\151\004F";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
